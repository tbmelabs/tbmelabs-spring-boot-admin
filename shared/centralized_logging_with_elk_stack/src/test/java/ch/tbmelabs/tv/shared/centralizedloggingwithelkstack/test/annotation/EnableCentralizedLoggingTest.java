...
public class EnableCentralizedLoggingTest {
  ...
  public void annotationShouldApplyToTypesOnly() {
    ...
    assertThat(EnableCentralizedLogging.class.getDeclaredAnnotation(Target.class).value())
        .isNotNull().containsExactly(ElementType.TYPE);
  }
  ...
  public void annotationShouldApplyToRetentionTargetRuntime() {
    ...
    assertThat(EnableCentralizedLogging.class.getDeclaredAnnotation(Retention.class).value())
        .isNotNull().isEqualTo(RetentionPolicy.RUNTIME);
  }
