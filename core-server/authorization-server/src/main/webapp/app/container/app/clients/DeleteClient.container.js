...
type DeleteClientContainerState = {
  existingClient: { ...clientType };
}

class DeleteClientContainer extends Component<DeleteClientContainer.propTypes, DeleteClientContainerState> {
  constructor(props: DeleteClientContainer.propTypes) {
    super(props);
...
DeleteClientContainer.propTypes = {
...
export default connect(mapStateToProps)(DeleteClientContainer);
