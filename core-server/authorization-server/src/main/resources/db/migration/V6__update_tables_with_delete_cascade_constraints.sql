...
ALTER TABLE ONLY user_has_roles
	...
	ADD CONSTRAINT user_has_roles_role FOREIGN KEY (user_role_id) REFERENCES user_roles(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY client_has_authorities
    ...
    ADD CONSTRAINT client_has_authorities_authority FOREIGN KEY (client_authority_id) REFERENCES client_authorities(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY client_has_grant_types
	...
	ADD CONSTRAINT client_has_grant_types_grant_type FOREIGN KEY (client_grant_type_id) REFERENCES client_grant_types(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY client_has_scopes
    ...
    ADD CONSTRAINT client_has_scopes_scope FOREIGN KEY (client_scope_id) REFERENCES client_scopes(id) ON DELETE CASCADE;
