...
public class ClientAuthorityAssociationTest {
  ...
  public void clientAuthorityAssociationShouldBeAnnotated() {
    ...
    assertThat(ClientAuthorityAssociation.class.getDeclaredAnnotation(JsonInclude.class).value())
        .isNotNull().isEqualTo(Include.NON_NULL);
    assertThat(ClientAuthorityAssociation.class.getDeclaredAnnotation(JsonIgnoreProperties.class)
