...
public class LoginEndpointBruteforceFilterServiceIntTest
  ...
  public void authenticationFailureListenerShouldBanIpAfterMaxLoginAttempts() {
    ...
    assertThat(ipBlacklistRepository.findAll().iterator().next())
        .hasFieldOrPropertyWithValue("startIp", "127.0.0.1")
