...
public class SpringMailConfigurationTest {
  ...
  public void springMailConfigurationShouldBeAnnotated() {
    ...
    assertThat(SpringMailConfiguration.class.getDeclaredAnnotation(Profile.class).value())
        .hasSize(1).containsExactly("!" + SpringApplicationProfile.NO_MAIL);
    assertThat(SpringMailConfiguration.class.getDeclaredAnnotation(PropertySource.class).value())
        .hasSize(1).containsExactly("classpath:configuration/mail.properties");
  }
